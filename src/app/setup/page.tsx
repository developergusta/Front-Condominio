...
import { Building2, Loader2, KeyRound, Mail, User, Hash, ArrowRight, CheckCircle2, Shield, Users } from "lucide-react";
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-400 text-base mb-10 leading-relaxed">
            Decisões transparentes, votações seguras e comunicação centralizada para toda a comunidade.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        ...
        >
          ...
          <p className="text-sm text-slate-500 mb-8">
            {isLoginMode ? "Entre com seu e-mail e senha para continuar." : "Preencha os dados para se registrar."}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {!isLoginMode && (
              ...
              >
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="condoId" className="text-xs font-semibold text-slate-700 uppercase tracking-wider">
                    Condomínio
                  </Label>
                  <select
                    id="condoId"
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="apt" className="text-xs font-semibold text-slate-700 uppercase tracking-wider">
                    Número do Apartamento / Bloco
                  </Label>
                  <div className="relative">
                    <Hash className="absolute left-3 top-2.5 h-4 w-4 text-slate-400" />
                    <Input id="apt" className="pl-9" value={apartmentNumber} onChange={e => setApartmentNumber(e.target.value)} required />
                  </div>
                </div>
              </motion.div>
            )}
